...
function createOnlineVisitorsCounterElement()
{
    ...
    if (existingElement === null) // Only creates a new element if does not exist yet.
    {
        ...
        button.style.cssText = 'z-index:100; position: fixed; bottom: 5px; left: 10px; background-color:transparent; -moz-border-radius:28px; -webkit-border-radius:28px; border-radius:28px; border:2px solid #FE980F; display:inline-block; cursor:pointer; font-family:Trebuchet MS; font-size:13px; padding:9px 15px; text-decoration:none; ';
